    ...
    function initiate_usage_event() {
        $(".usage_cat_id").on('change', function () {
            ...
            if (!$.isNumeric(currentElement.val())) {
                ...
                if (usagecatlist !== '') {
                        if(usagecatlist!=20){
                            $("#Getrecordlandrecord1").hide();
                        }
                        else
                        {
                            $("#Getrecordlandrecord1").show();
                        }
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12">  
                            ...
                            <?php } ?>  
                            <?php if (!empty($corp_config_valuation)) { ?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">List of Plot Numbers</h4>
            </div>
